...
|---------|--------|------------|
| Stripe ↔ ISO 8583 bridge | Coming Soon — stubs staged | [ISO 8583 switch](rogue-repo/src/switch/) |
| Game assets (all titles) | Coming Soon — waiting on [Pixel Forge](https://github.com/cochranblock/pixel-forge) | [Pixel Forge](https://github.com/cochranblock/pixel-forge) |
| Rogue Bucks purchase flow | Coming Soon — waiting on Stripe bridge | Stripe ↔ ISO 8583 |

> **Game development begins after [Pixel Forge](https://github.com/cochranblock/pixel-forge) ships.** All game assets will be AI-generated by our own model. This is a dependency, not a delay.
...
- **switch/stripe** (`src/switch/stripe.rs`): Stripe ↔ ISO 8583 translation layer (Coming Soon — stubs only)
