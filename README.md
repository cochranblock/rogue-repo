...
|-----------|--------|---------|
| **Bank/Switch TCP** | Not connected | ISO 8583 messages build correctly but are never sent. No TCP endpoint to a bank or processor. `/buy-bucks` logs "bank send not yet wired" and credits bucks without actual payment. |
