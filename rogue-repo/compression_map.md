...
f127 = send_and_receive (ISO 8583 TCP round-trip, length-prefixed)
f128 = connect (establish TCP connection to switch endpoint)
f129 = send_and_parse (f127 + f18 convenience wrapper)
...
t39  = SwitchEndpoint (host, port, timeout_ms — bank TCP config)
