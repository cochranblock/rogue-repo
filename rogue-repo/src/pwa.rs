  ...
  <main id="main" class="content">
    ...
    <section id="featured" class="featured" aria-label="Featured apps">
      ...
      <div class="pipeline-notice">
        <p><strong>Game development begins after <a href="https://github.com/cochranblock/pixel-forge">Pixel Forge</a> ships.</strong> All game assets will be AI-generated by our own model. This is a dependency, not a delay.</p>
      </div>
      <div class="app-grid">
        <a href="/apps/rogue-runner" class="app-card" style="animation-delay: 0.05s">
          <div class="app-icon"><img src="/assets/apps/rogue-runner.webp" alt="Rogue Runner" width="96" height="96"></div>
          <h3>Rogue Runner</h3>
        ...
        <a href="/apps/null-terminal?demo=1" class="app-card" style="animation-delay: 0.25s">
          <div class="app-icon"><img src="/assets/apps/null-terminal.webp" alt="Null Terminal" width="96" height="96"></div>
          <h3>Null Terminal</h3>
    ...
    <section id="economy" class="economy-section" aria-label="Rogue Bucks economy">
      ...
      <div class="economy-card economy-coming-soon">
        ...
        <p class="economy-placeholder"><a href="https://github.com/cochranblock/rogue-repo/blob/main/rogue-repo/src/switch/">Coming Soon — waiting on Stripe↔ISO 8583 bridge</a></p>
      </div>
